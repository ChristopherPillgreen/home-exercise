...
export const createUser = async (
  ...
  em: EntityManager,
  data: { userFirstName: string; userLastName: string; userEmail: string; userPassword: string;}
): Promise<User> => {
...
// Get a User by ID
export const getUserById = async (em: EntityManager, userID: number): Promise<User | null> => {
...
// Update a User
export const updateUser = async (em: EntityManager, userID: number, data: Partial<User>): Promise<User | null> => {
...
// Delete a User
export const deleteUser = async (em: EntityManager, userID: number): Promise<boolean> => {
  const user = await getUserById(em, userID);
